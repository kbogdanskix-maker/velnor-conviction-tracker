import {
  ...
  CreditCard, TrendingDown, Receipt, Banknote, Activity,
  Bell, Repeat, Brain,
...
export const GUIDE_STEPS: GuideStep[] = [
  ...
  },
  {
    ...
    description:
      "Add assets and liabilities to see your complete financial picture and how your investments fit alongside the rest of your money.",
    href: "/net-worth",
    icon: Wallet,
    cta: "Add Accounts",
  },
