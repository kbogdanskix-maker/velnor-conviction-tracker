    ...
    >
      ...
      <div
        ...
        style={{
          ...
          top: "-40%",
          background:
            "radial-gradient(circle, rgba(26, 168, 187,0.06) 0%, rgba(26, 168, 187,0.015) 35%, transparent 60%)",
          filter: "blur(120px)",
      ...
      <div
        ...
        style={{
          ...
          top: "15%",
          background:
            "radial-gradient(circle, rgba(26, 168, 187,0.045) 0%, rgba(26, 168, 187,0.01) 40%, transparent 60%)",
          filter: "blur(100px)",
      ...
      <div
        ...
        style={{
          ...
          bottom: "-50%",
          background:
            "radial-gradient(circle, rgba(26, 168, 187,0.04) 0%, rgba(6,182,212,0.015) 35%, transparent 60%)",
          filter: "blur(110px)",
