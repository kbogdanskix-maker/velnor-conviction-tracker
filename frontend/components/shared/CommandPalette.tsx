...
const ITEMS: SearchItem[] = [
  ...
  { label: "Affordability", href: "/affordability", icon: Calculator, keywords: ["loan", "mortgage", "car", "house", "afford"], group: "Financial Planning" },
  { label: "Debt Payoff", href: "/debt-payoff", icon: TrendingDown, keywords: ["debt", "snowball", "avalanche", "payoff", "loan"], group: "Financial Planning" },
  ...
  { label: "Insurance Gap Analyzer", href: "/insurance", icon: Shield, keywords: ["insurance", "coverage", "gap", "health", "auto", "life", "disability", "umbrella", "policy", "premium"], group: "Financial Planning" },
  ...
  { label: "What If", href: "/what-if", icon: Sparkles, keywords: ["what if", "simulator", "scenario", "hypothetical"], group: "Projections" },
  ...
  { label: "Emergency Fund", href: "/emergency-fund", icon: Shield, keywords: ["emergency", "fund", "rainy day", "safety net", "liquid", "months"], group: "Projections" },
  { label: "Financial Milestones", href: "/milestones", icon: Trophy, keywords: ["milestones", "achievements", "badges", "progress", "goals", "gamification"], group: "Projections" },
